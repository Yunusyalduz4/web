-- KUADO Veritabanı Tablolarını Oluşturma SQL Scripti
-- Bu script tüm tabloları, sütunları ve kısıtlamaları oluşturur
-- Veri içermez, sadece yapı oluşturur

-- PostgreSQL için gerekli extension'ları etkinleştir
...
DO $$
BEGIN
    RAISE NOTICE 'KUADO veritabanı tabloları başarıyla oluşturuldu!';
    RAISE NOTICE 'Toplam 25 tablo oluşturuldu.';
    RAISE NOTICE 'Tüm indeksler ve trigger''lar eklendi.';
END $$;
